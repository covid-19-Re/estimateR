...
The example is simplified version of the linelists gathered by the Federal Office of Public Health in Switzerland.
We prepared the data by removing all columns non-relevant to our analysis to ensure the anonimization of the data.
To keep the data handling fast and easy, we restricted the data from February to July 2020.
