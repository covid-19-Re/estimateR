...
delay_distribution <- combine_incubation_with_reporting_delay(
  parm1_incubation = shape_incubation,
...
estimation_window <- 3
# The estimation window corresponds to the size of the sliding window used in EpiEstim (see help(estimate_Re)
# for additional details). Here, it is set to three days.
