...
test_that("correct_for_partially_observed_data() is correct with large gap_to_present", {
  toy_incidence <- c(9, 3, 4, 7, 8, 0, 2, 1, 0)
  toy_delay <- c(0.05, 0.05, 0.3, 0.2, 0.1, 0.3)

  corrected_result <- correct_for_partially_observed_data(toy_incidence, toy_delay, cutoff_observation_probability = 0.11, gap_to_present = 10)
  corrected_result <- correct_for_partially_observed_data(toy_incidence, toy_delay, cutoff_observation_probability = 0.11, gap_to_present = 1)
